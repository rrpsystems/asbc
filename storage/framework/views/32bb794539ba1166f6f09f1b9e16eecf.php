...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label','hint','invalidate']));
...
foreach (array_filter((['label','hint','invalidate']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = TallStackUi\View\Components\Form\Input::resolve(['label' => $label,'hint' => $hint,'invalidate' => $invalidate] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\storage\framework\views/083f88f933bdcd5382ba6ec116cb53d0.blade.php ENDPATH**/ ?>