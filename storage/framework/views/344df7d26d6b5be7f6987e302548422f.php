...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['btnCreate' => 'slide-create']));
...
foreach (array_filter((['btnCreate' => 'slide-create']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="inline-flex rounded-md shadow-sm" role="group">
    <button type="button" title="Adicionar um novo ramal" wire:click="$dispatch('<?php echo e($btnCreate); ?>')"
...
<?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\resources\views/components/buttons/group.blade.php ENDPATH**/ ?>