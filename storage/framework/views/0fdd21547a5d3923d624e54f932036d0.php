            ...
            <div class="p-4 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($totalClientes); ?></p>
                    </div>
            ...
            <div class="p-4 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white">R$ <?php echo e(number_format($receitaTotal, 2, ',', '.')); ?></p>
                    </div>
                    <div class="p-3 bg-white bg-opacity-20 rounded-full">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                            <td class="px-4 py-3">
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer->nomefantasia && $customer->razaosocial != $customer->nomefantasia): ?>
                                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($customer->razaosocial); ?></p>
                            ...
                            <td class="px-4 py-3 text-center">
                                <span class="px-3 py-1 text-sm font-semibold rounded-full bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100">
                                    <?php echo e($customer->faturas_count); ?>

                                </span>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer->revenueSummaries->isNotEmpty()): ?>
                                    <?php
                                        $lastInvoice = $customer->revenueSummaries->first();
                                    ?>
                                    <span class="text-sm text-gray-700 dark:text-gray-300">
                                        <?php echo e(str_pad($lastInvoice->mes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($lastInvoice->ano); ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                <a href="<?php echo e(route('customers.invoices', $customer->id)); ?>"
...
<?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\resources\views/livewire/invoices/list-customers.blade.php ENDPATH**/ ?>