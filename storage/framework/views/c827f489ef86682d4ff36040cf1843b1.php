    ...
    <div class="container flex-grow mx-auto">
        ...
        <div class="grid grid-cols-1 gap-4 p-4 mb-6 bg-gray-50 dark:bg-gray-700 rounded-lg md:grid-cols-3">
            ...
            <div>
                ...
                <select wire:model.live="ano" class="w-full px-3 py-2 border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($y = now()->year; $y >= now()->year - 3; $y--): ?>
            ...
            <div>
                ...
                <div class="px-3 py-2 font-semibold text-blue-600 bg-blue-50 dark:bg-blue-900 dark:text-blue-200 rounded-md">
                    <?php echo e(str_pad($mes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($ano); ?>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-green-700 dark:text-green-200">
                            R$ <?php echo e(number_format($lucro, 2, ',', '.')); ?>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-blue-700 dark:text-blue-200">
                            R$ <?php echo e(number_format($receita, 2, ',', '.')); ?>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-purple-700 dark:text-purple-200">
                            <?php echo e(number_format($margemLucro, 1, ',', '.')); ?>%
                        </p>
                    </div>
        ...
        <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-cyan-700 dark:text-cyan-200">
                            R$ <?php echo e(number_format($receitaChamadas, 2, ',', '.')); ?>

                        </p>
                        <p class="text-xs text-cyan-500 dark:text-cyan-400 mt-1">
                            <?php echo e($receita > 0 ? number_format(($receitaChamadas / $receita) * 100, 1, ',', '.') : 0); ?>% do total
                        </p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-teal-700 dark:text-teal-200">
                            R$ <?php echo e(number_format($receitaProdutos, 2, ',', '.')); ?>

                        </p>
                        <p class="text-xs text-teal-500 dark:text-teal-400 mt-1">
                            <?php echo e($receita > 0 ? number_format(($receitaProdutos / $receita) * 100, 1, ',', '.') : 0); ?>% do total
                        </p>
                    </div>
            ...
            <div class="p-4 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900 dark:to-orange-800 rounded-lg shadow">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($mesAnterior) && isset($anoAnterior)): ?>
                    <p class="mb-3 text-xs font-medium text-orange-600 dark:text-orange-300">
                        Variação vs <?php echo e(str_pad($mesAnterior, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($anoAnterior); ?>

                    </p>
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-gray-700 dark:text-gray-300">Receita:</span>
                            <span class="text-sm font-bold <?php echo e(isset($variacaoReceita) && $variacaoReceita >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                <?php if(isset($variacaoReceita)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variacaoReceita > 0): ?> ↑ <?php elseif($variacaoReceita < 0): ?> ↓ <?php else: ?> — <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php echo e(number_format(abs($variacaoReceita), 1, ',', '.')); ?>%
                                <?php else: ?>
                                    —
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold <?php echo e(isset($variacaoCusto) && $variacaoCusto >= 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'); ?>">
                                <?php if(isset($variacaoCusto)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variacaoCusto > 0): ?> ↑ <?php elseif($variacaoCusto < 0): ?> ↓ <?php else: ?> — <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php echo e(number_format(abs($variacaoCusto), 1, ',', '.')); ?>%
                                <?php else: ?>
                                    —
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold <?php echo e(isset($variacaoLucro) && $variacaoLucro >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                <?php if(isset($variacaoLucro)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variacaoLucro > 0): ?> ↑ <?php elseif($variacaoLucro < 0): ?> ↓ <?php else: ?> — <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php echo e(number_format(abs($variacaoLucro), 1, ',', '.')); ?>%
                                <?php else: ?>
                                    —
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold <?php echo e(isset($variacaoMargem) && $variacaoMargem >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                <?php if(isset($variacaoMargem)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variacaoMargem > 0): ?> ↑ <?php elseif($variacaoMargem < 0): ?> ↓ <?php else: ?> — <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php echo e(number_format(abs($variacaoMargem), 1, ',', '.')); ?> p.p.
                                <?php else: ?>
                                    —
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
        ...
        <div class="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-2">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php
                                ...
                                $totalLucro = 0;
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $evolucao; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <tr class="border-b border-gray-100 dark:border-gray-700">
                                    <td class="px-2 py-2 font-medium text-gray-900 dark:text-gray-100"><?php echo e($item['mes']); ?></td>
                                    <td class="px-2 py-2 text-right text-blue-600 dark:text-blue-400">R$ <?php echo e(number_format($item['receita'], 2, ',', '.')); ?></td>
                                    <td class="px-2 py-2 text-right text-red-600 dark:text-red-400">R$ <?php echo e(number_format($item['custo'], 2, ',', '.')); ?></td>
                                    <td class="px-2 py-2 text-right font-bold <?php echo e($item['lucro'] >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                                        R$ <?php echo e(number_format($item['lucro'], 2, ',', '.')); ?>

                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($evolucao) > 0): ?>
                                <tr class="border-t-2 border-gray-400 dark:border-gray-500 bg-gray-100 dark:bg-gray-700 font-bold">
                                    ...
                                    <td class="px-2 py-3 text-right text-blue-700 dark:text-blue-300">R$ <?php echo e(number_format($totalReceita, 2, ',', '.')); ?></td>
                                    <td class="px-2 py-3 text-right text-red-700 dark:text-red-300">R$ <?php echo e(number_format($totalCusto, 2, ',', '.')); ?></td>
                                    <td class="px-2 py-3 text-right <?php echo e($totalLucro >= 0 ? 'text-green-700 dark:text-green-300' : 'text-red-700 dark:text-red-300'); ?>">
                                        R$ <?php echo e(number_format($totalLucro, 2, ',', '.')); ?>
            ...
            <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $topClientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div class="flex-1">
                                <p class="font-semibold text-gray-900 dark:text-gray-100"><?php echo e($cliente->customer->nomefantasia ?? $cliente->customer->razaosocial ?? 'N/A'); ?></p>
                                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($cliente->minutos_total ?? 0); ?> minutos</p>
                            </div>
                            <div class="text-right">
                                <p class="font-bold text-green-600 dark:text-green-400">R$ <?php echo e(number_format($cliente->receita_total_calculada, 2, ',', '.')); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($distribuicaoServico->fixo ?? 0, 2, ',', '.')); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($distribuicaoServico->movel ?? 0, 2, ',', '.')); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($distribuicaoServico->internacional ?? 0, 2, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $custosOperadora; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div class="flex items-center justify-between mb-2">
                                <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($item->carrier->operadora ?? 'N/A'); ?></span>
                                <span class="font-bold text-red-600 dark:text-red-400">R$ <?php echo e(number_format($item->total, 2, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400">
                                <span>Fixo: R$ <?php echo e(number_format($item->custo_fixo, 2, ',', '.')); ?></span>
                                <span>Variável: R$ <?php echo e(number_format($item->custo_variavel, 2, ',', '.')); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custosOperadora->isEmpty()): ?>
...
<?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\resources\views/livewire/dashboard/financial.blade.php ENDPATH**/ ?>