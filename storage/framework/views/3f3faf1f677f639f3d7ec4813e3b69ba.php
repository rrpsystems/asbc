    ...
    <div class="container flex-grow mx-auto space-y-6">
        ...
        <div class="flex flex-col items-start justify-between my-4 sm:flex-row sm:items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Visão geral do sistema de tarifação - <?php echo e(now()->translatedFormat('F Y')); ?></p>
            </div>
                ...
                <div class="flex gap-2 p-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
                    <button wire:click="setPeriodo('hoje')"
                            class="px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200
                                   <?php echo e($periodoFiltro === 'hoje' ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'); ?>">
                        Hoje
                    </button>
                    <button wire:click="setPeriodo('semana')"
                            class="px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200
                                   <?php echo e($periodoFiltro === 'semana' ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'); ?>">
                        Semana
                    </button>
                    <button wire:click="setPeriodo('mes')"
                            class="px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200
                                   <?php echo e($periodoFiltro === 'mes' ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'); ?>">
                        Mês
                    </button>
                </div>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400"><?php echo e(now()->translatedFormat('d \d\e F \d\e Y')); ?></p>
                    </div>
                </div>
...
<?php endif; ?>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xl font-bold text-white truncate">R$ <?php echo e(number_format($todayCost, 2, ',', '.')); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xl font-bold text-white truncate"><?php echo e(number_format($todayCalls, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xl font-bold text-white truncate"><?php echo e(gmdate('H:i', $todayDuration)); ?>h</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">R$ <?php echo e(number_format($custoTotal, 2, ',', '.')); ?></p>
                            <p class="mt-1 text-xs text-green-100 opacity-80"><?php echo e($periodoLabel); ?></p>
                        </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e(number_format($data2->sum('max_customer_calls'), 0, ',', '.')); ?></p>
                            <p class="mt-1 text-xs text-blue-100 opacity-80"><?php echo e($periodoLabel); ?></p>
                        </div>
                        <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                            <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e(gmdate('H:i', $data2->sum('total_billsec'))); ?>h</p>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e($maxChannelsInfo['max']); ?></p>
                            <p class="mt-1 text-xs text-red-100 opacity-80"><?php echo e($maxChannelsInfo['hour']); ?></p>
                        </div>
                        <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                            <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'bolt'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e($callsPerHour['peak']['calls']); ?></p>
                            <p class="mt-1 text-xs text-purple-100 opacity-80"><?php echo e($callsPerHour['peak']['hour_range']); ?></p>
                            <div class="flex gap-2 mt-2 text-xs text-purple-100">
                                <span>✓ <?php echo e($callsPerHour['peak']['answered']); ?></span>
                                <span>✗ <?php echo e($callsPerHour['peak']['failed']); ?></span>
                            </div>
                        </div>
                        <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                            <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="overflow-hidden bg-white shadow-md dark:bg-gray-800 rounded-lg">
                <div class="p-6 border-b bg-gradient-to-r from-orange-500 to-red-600 border-orange-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-lg font-bold text-white">Distribuição de Chamadas por Tipo (<?php echo e($periodoLabel); ?>)</h4>
                        ...
                        <div class="flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm rounded-lg">
                            <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'chart-pie'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <div class="p-6">
                    ...
                    ?>
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $callsByType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center gap-2">
                                        <div class="w-3 h-3 rounded-full <?php echo e($color['bg']); ?>"></div>
                                        <span class="text-sm font-semibold text-gray-700 dark:text-gray-300"><?php echo e($type->tipo); ?></span>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">
                                            <?php echo e(number_format($type->total)); ?> chamadas
                                        </span>
                                        <span class="inline-flex items-center px-2.5 py-1 text-xs font-bold <?php echo e($color['text']); ?> <?php echo e($color['bg-light']); ?> rounded-full <?php echo e($color['dark-bg']); ?> <?php echo e($color['dark-text']); ?>">
                                            <?php echo e(number_format($percentage, 1)); ?>%
                                        </span>
                                    </div>
                                </div>
                                <div class="w-full h-3 overflow-hidden bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="h-full <?php echo e($color['bg']); ?> rounded-full transition-all duration-500" style="width: <?php echo e($percentage); ?>%"></div>
                                </div>
                            </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($callsByType->isNotEmpty()): ?>
                            <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-bold text-gray-700 dark:text-gray-300">Total</span>
                                    <span class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalCalls)); ?></span>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
        ...
        <div class="grid grid-cols-1 gap-6">
            <div class="overflow-hidden bg-white shadow-md dark:bg-gray-800 rounded-lg">
                <div class="p-6 border-b bg-gradient-to-r from-indigo-500 to-purple-600 border-indigo-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-lg font-bold text-white">Distribuição de Chamadas por Hora (<?php echo e($periodoLabel); ?>)</h4>
                            <p class="mt-1 text-sm text-indigo-100">Pico às <?php echo e($callsPerHour['peak']['hour']); ?> com <?php echo e(number_format($callsPerHour['peak']['calls'])); ?> chamadas</p>
                        </div>
                        <div class="flex items-center justify-center w-12 h-12 bg-white/20 backdrop-blur-sm rounded-lg">
                            <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($hour = 0; $hour < 24; $hour++): ?>
                                    <?php
                                    ...
                                    ?>
                                    <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50 <?php echo e($isPeak ? 'bg-purple-50 dark:bg-purple-900/20' : ''); ?>">
                                        <td class="px-4 py-3 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center gap-2">
                                                <?php echo e($hourFormatted); ?>

                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPeak): ?>
                                        ...
                                        <td class="px-4 py-3 text-sm font-semibold text-right text-gray-900 whitespace-nowrap dark:text-white">
                                            <?php echo e(number_format($totalCalls)); ?>

                                        </td>
                                        <td class="px-4 py-3 text-sm text-right text-green-600 whitespace-nowrap dark:text-green-400">
                                            <?php echo e(number_format($answeredCalls)); ?>

                                        </td>
                                        <td class="px-4 py-3 text-sm text-right text-red-600 whitespace-nowrap dark:text-red-400">
                                            <?php echo e(number_format($failedCalls)); ?>

                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center gap-2">
                                                <div class="flex-1 h-6 overflow-hidden bg-gray-200 rounded-full dark:bg-gray-700">
                                                    <div class="h-full <?php echo e($isPeak ? 'bg-gradient-to-r from-purple-500 to-indigo-500' : 'bg-gradient-to-r from-blue-400 to-blue-500'); ?> rounded-full transition-all duration-300"
                            ...
                            <tfoot>
                                <tr class="font-bold bg-gray-100 dark:bg-gray-900">
                                    ...
                                    <td class="px-4 py-3 text-sm text-right text-gray-900 dark:text-white">
                                        <?php echo e(number_format($callsPerHour['hourly']->sum('total_calls'))); ?>

                                    </td>
                                    <td class="px-4 py-3 text-sm text-right text-green-600 dark:text-green-400">
                                        <?php echo e(number_format($callsPerHour['hourly']->sum('answered_calls'))); ?>

                                    </td>
                                    <td class="px-4 py-3 text-sm text-right text-red-600 dark:text-red-400">
                                        <?php echo e(number_format($callsPerHour['hourly']->sum('failed_calls'))); ?>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg dark:bg-gray-800 rounded-2xl hover:shadow-xl">
                <div class="p-6 border-b bg-gradient-to-r from-purple-500 to-pink-600 border-purple-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-lg font-bold text-white">🏆 Top 10 - Volume de Chamadas (<?php echo e($periodoLabel); ?>)</h4>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data2->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="transition-colors hover:bg-purple-50 dark:hover:bg-gray-700/50">
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->iteration <= 3): ?>
                                                <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white rounded-full
                                                    <?php echo e($loop->iteration == 1 ? 'bg-gradient-to-br from-yellow-400 to-yellow-600' : ''); ?>

                                                    <?php echo e($loop->iteration == 2 ? 'bg-gradient-to-br from-gray-300 to-gray-500' : ''); ?>

                                                    <?php echo e($loop->iteration == 3 ? 'bg-gradient-to-br from-orange-400 to-orange-600' : ''); ?>
                                            ...
                                            <div class="flex items-center gap-2">
                                                <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 bg-purple-100 rounded-lg dark:bg-purple-900/30">
                                                    <span class="text-xs font-bold text-purple-600 dark:text-purple-400">
                                                        <?php echo e($item->customer ? substr($item->customer->razaosocial, 0, 2) : 'N/A'); ?>

                                                    </span>
                                                </div>
                                                <span class="font-medium truncate max-w-[120px]" title="<?php echo e($item->customer?->razaosocial ?? 'Cliente não identificado'); ?>">
                                                    <?php echo e($item->customer ? Str::limit($item->customer->razaosocial, 15) : 'Cliente não identificado'); ?>
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-1 text-xs font-bold text-purple-700 bg-purple-100 rounded-full dark:bg-purple-900/30 dark:text-purple-400">
                                                <?php echo e(number_format($item->max_customer_calls)); ?>
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <span class="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-pink-700 bg-pink-100 rounded-full dark:bg-pink-900/30 dark:text-pink-400">
                                                ...
                                                <?php echo e(gmdate('H:i', $item->total_billsec)); ?>
            ...
            <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg dark:bg-gray-800 rounded-2xl hover:shadow-xl">
                <div class="p-6 border-b bg-gradient-to-r from-blue-500 to-cyan-600 border-blue-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-lg font-bold text-white">🏆 Top 10 - Destinos (<?php echo e($periodoLabel); ?>)</h4>
                ...
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topDestinos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destino): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="transition-colors hover:bg-blue-50 dark:hover:bg-gray-700/50">
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-1 text-xs font-bold text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900/30 dark:text-blue-400">
                                                <?php echo e(number_format($destino->total_calls)); ?>
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <span class="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-cyan-700 bg-cyan-100 rounded-full dark:bg-cyan-900/30 dark:text-cyan-400">
                                                ...
                                                <?php echo e(gmdate('H:i', $destino->total_duration)); ?>
            ...
            <div class="overflow-hidden transition-all duration-300 bg-white shadow-lg dark:bg-gray-800 rounded-2xl hover:shadow-xl">
                <div class="p-6 border-b bg-gradient-to-r from-emerald-500 to-green-600 border-emerald-600">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-lg font-bold text-white">🏆 Top 10 - Canais Simultâneos (<?php echo e($periodoLabel); ?>)</h4>
                ...
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data1->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="transition-colors hover:bg-emerald-50 dark:hover:bg-gray-700/50">
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-300">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="font-medium truncate max-w-[150px]" title="<?php echo e($item->customer?->razaosocial ?? 'Cliente não identificado'); ?>">
                                                    <?php echo e($item->customer ? Str::limit($item->customer->razaosocial, 20) : 'Cliente não identificado'); ?>
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <span class="inline-flex items-center px-3 py-1 text-sm font-bold text-emerald-700 bg-emerald-100 rounded-full dark:bg-emerald-900/30 dark:text-emerald-400">
                                                <?php echo e($item->max_customer_channels); ?>
                ...
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentCalls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $call): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                        <td class="px-4 py-3 text-xs text-gray-900 whitespace-nowrap dark:text-gray-300">
                                            <?php echo e(\Carbon\Carbon::parse($call->calldate)->format('d/m H:i:s')); ?>
                                            ...
                                            <div class="flex items-center gap-2">
                                                <div class="flex items-center justify-center flex-shrink-0 w-6 h-6 bg-slate-100 rounded dark:bg-slate-900/30">
                                                    <span class="text-xs font-bold text-slate-600 dark:text-slate-400">
                                                        <?php echo e(substr($call->customer->razaosocial ?? 'N/A', 0, 1)); ?>

                                                    </span>
                                                </div>
                                                <span class="text-xs truncate max-w-[100px]" title="<?php echo e($call->customer->razaosocial ?? 'N/A'); ?>">
                                                    <?php echo e(Str::limit($call->customer->razaosocial ?? 'N/A', 12)); ?>

                                                </span>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 text-xs font-mono text-gray-900 dark:text-gray-300">
                                            <?php echo e($call->numero); ?>
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <span class="inline-flex items-center px-2 py-1 text-xs font-semibold text-gray-700 bg-gray-100 rounded dark:bg-gray-700 dark:text-gray-300">
                                                <?php echo e(gmdate('i:s', $call->billsec)); ?>
                                        ...
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            ...
                                            ?>
                                            <span class="inline-flex items-center px-2 py-1 text-xs font-semibold rounded <?php echo e($status['classes']); ?>">
                                    ...
                                    <tr class="transition-colors hover:bg-sky-50 dark:hover:bg-gray-700/50">
                                        <td class="px-4 py-3 text-sm text-gray-900 whitespace-nowrap dark:text-gray-300">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="font-semibold"><?php echo e(sprintf('%02d:00', $item->hour_of_day)); ?></span>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 text-center whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-1 text-xs font-semibold text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900/30 dark:text-blue-400">
                                                <?php echo e($item->max_carrier_channels); ?>
...
<?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\resources\views/livewire/dashboard/index.blade.php ENDPATH**/ ?>