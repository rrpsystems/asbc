...
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'arrow-path'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                    ...
                    <div class="p-5">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-white"><?php echo e(number_format($stats['total_cdrs'] ?? 0, 0, ',', '.')); ?></p>
                            </div>
                            <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                                <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'phone'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                    ...
                    <div class="p-5">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-white"><?php echo e(number_format($stats['tarifados'] ?? 0, 0, ',', '.')); ?></p>
                            </div>
                            <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                                <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
...
<?php endif; ?>
                ...
                <!-- Pendentes -->
                <a href="<?php echo e(route('report.cdr', ['stat' => ['Pendente']])); ?>"
                    ...
                    <div class="p-5">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-white"><?php echo e(number_format($stats['pendentes'] ?? 0, 0, ',', '.')); ?></p>
                                <p class="mt-1 text-xs text-orange-100 opacity-75">👁️ Clique para ver detalhes</p>
                            </div>
                            <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                                <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'clock'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <!-- Com Erro -->
                <a href="<?php echo e(route('report.cdr', ['stat' => ['Erro_Tarifa', 'Tarifa_Nao_Encontrada', 'Dados_Invalidos', 'Erro_Permanente']])); ?>"
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-white">
                                    <?php echo e(number_format(($stats['erro_tarifa'] ?? 0) + ($stats['tarifa_nao_encontrada'] ?? 0) + ($stats['dados_invalidos'] ?? 0) + ($stats['erro_permanente'] ?? 0), 0, ',', '.')); ?>
                            ...
                            <div class="p-3 bg-white bg-opacity-30 rounded-lg">
                                <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'exclamation-circle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2 lg:grid-cols-4">
            <a href="<?php echo e(route('report.cdr', ['stat' => ['Erro_Tarifa']])); ?>"
               class="block p-4 transition-all duration-200 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600 hover:shadow-md hover:border-red-300 dark:hover:border-red-600 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($stats['erro_tarifa'] ?? 0, 0, ',', '.')); ?></p>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('report.cdr', ['stat' => ['Tarifa_Nao_Encontrada']])); ?>"
               class="block p-4 transition-all duration-200 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600 hover:shadow-md hover:border-yellow-300 dark:hover:border-yellow-600 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($stats['tarifa_nao_encontrada'] ?? 0, 0, ',', '.')); ?></p>
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">👁️ Ver CDRs</p>
                    </div>
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'question-mark-circle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('report.cdr', ['stat' => ['Dados_Invalidos']])); ?>"
               class="block p-4 transition-all duration-200 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600 hover:shadow-md hover:border-orange-300 dark:hover:border-orange-600 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($stats['dados_invalidos'] ?? 0, 0, ',', '.')); ?></p>
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">👁️ Ver CDRs</p>
                    </div>
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'exclamation-triangle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\TallStackUi\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 text-orange-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf0c10903472319464d99a08725e554d)): ?>
<?php $attributes = $__attributesOriginalcf0c10903472319464d99a08725e554d; ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('report.cdr', ['stat' => ['Erro_Permanente']])); ?>"
               class="block p-4 transition-all duration-200 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600 hover:shadow-md hover:border-red-300 dark:hover:border-red-700 hover:scale-105">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($stats['erro_permanente'] ?? 0, 0, ',', '.')); ?></p>
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">👁️ Ver CDRs</p>
                    </div>
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'no-symbol'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-3">
            ...
            <div class="p-4 bg-white border-l-4 border-green-500 rounded-lg shadow-md dark:bg-gray-700">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['ultimo_tarifado']): ?>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        <strong>ID:</strong> #<?php echo e($stats['ultimo_tarifado']->id); ?><br>
                        <strong>Número:</strong> <?php echo e($stats['ultimo_tarifado']->numero); ?><br>
                        <strong>Valor:</strong> R$ <?php echo e(number_format($stats['ultimo_tarifado']->valor_venda ?? 0, 2, ',', '.')); ?><br>
                        <strong>Data:</strong> <?php echo e($stats['ultimo_tarifado']->updated_at?->format('d/m/Y H:i:s')); ?>
            ...
            <div class="p-4 bg-white border-l-4 border-blue-500 rounded-lg shadow-md dark:bg-gray-700">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stats['ultimo_cdr']): ?>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        <strong>ID:</strong> #<?php echo e($stats['ultimo_cdr']->id); ?><br>
                        <strong>Número:</strong> <?php echo e($stats['ultimo_cdr']->numero); ?><br>
                        <strong>Status:</strong> <span class="px-2 py-1 text-xs rounded <?php echo e($stats['ultimo_cdr']->status === 'Tarifada' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>"><?php echo e($stats['ultimo_cdr']->status); ?></span><br>
                        <strong>Data:</strong> <?php echo e(\Carbon\Carbon::parse($stats['ultimo_cdr']->calldate)?->format('d/m/Y H:i:s')); ?>
            ...
            <div class="p-4 bg-white border-l-4 border-purple-500 rounded-lg shadow-md dark:bg-gray-700">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    <strong>Jobs Pendentes:</strong> <?php echo e($queueStats['jobs_pendentes']); ?><br>
                    <strong>Jobs Falhados:</strong> <?php echo e($queueStats['jobs_falhados']); ?><br>
                    <strong>Cache Driver:</strong> <?php echo e($cacheStats['driver'] ?? 'N/A'); ?><br>
                    <strong>Total Rates:</strong> <?php echo e(number_format($stats['total_rates'] ?? 0, 0, ',', '.')); ?>
        ...
        <div class="p-6 mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="grid grid-cols-1 gap-3 md:grid-cols-3 lg:grid-cols-5">
                ...
                <button wire:click="tarifar" wire:loading.attr="disabled"
                    ...
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'play'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\TallStackUi\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 mb-2 text-purple-600 dark:text-purple-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf0c10903472319464d99a08725e554d)): ?>
<?php $attributes = $__attributesOriginalcf0c10903472319464d99a08725e554d; ?>
...
<?php $attributes = $attributes->except(\TallStackUi\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 mb-2 text-blue-600 dark:text-blue-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf0c10903472319464d99a08725e554d)): ?>
<?php $attributes = $__attributesOriginalcf0c10903472319464d99a08725e554d; ?>
...
<?php $attributes = $attributes->except(\TallStackUi\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 mb-2 text-orange-600 dark:text-orange-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf0c10903472319464d99a08725e554d)): ?>
<?php $attributes = $__attributesOriginalcf0c10903472319464d99a08725e554d; ?>
...
<?php endif; ?>
                ...
                <!-- Retry Jobs Falhados -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($queueStats['jobs_falhados'] > 0): ?>
                <button wire:click="retryJobsFalhados" wire:loading.attr="disabled"
                    wire:confirm="Reprocessar todos os <?php echo e($queueStats['jobs_falhados']); ?> jobs falhados?"
                    ...
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'arrow-path-rounded-square'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\TallStackUi\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 mb-2 text-yellow-600 dark:text-yellow-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf0c10903472319464d99a08725e554d)): ?>
<?php $attributes = $__attributesOriginalcf0c10903472319464d99a08725e554d; ?>
...
<?php endif; ?>
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($queueStats['jobs_falhados']); ?> jobs</span>
...
<?php $attributes = $attributes->except(\TallStackUi\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 mb-2 text-red-600 dark:text-red-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf0c10903472319464d99a08725e554d)): ?>
<?php $attributes = $__attributesOriginalcf0c10903472319464d99a08725e554d; ?>
        ...
        <div class="p-6 mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-3">
                <div class="p-4 bg-gradient-to-br from-teal-500 to-teal-600 rounded-lg shadow">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e(number_format($revenueStats['total_resumos'] ?? 0, 0, ',', '.')); ?></p>
                </div>
                ...
                <div class="p-4 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg shadow">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e(number_format($revenueStats['mes_atual'] ?? 0, 0, ',', '.')); ?></p>
                </div>
                ...
                <div class="p-4 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg shadow">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e(number_format($batchStats['total_batches'] ?? 0, 0, ',', '.')); ?></p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($batchStats['total_cdrs'] ?? 0) > 0): ?>
                        <p class="text-xs text-indigo-100 mt-1"><?php echo e(number_format($batchStats['total_cdrs'], 0, ',', '.')); ?> CDRs aguardando</p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>

            <!-- Último Resumo Atualizado -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($revenueStats['ultimo_resumo'] ?? null): ?>
            <div class="p-4 mb-4 bg-white border-l-4 border-teal-500 rounded-lg shadow-md dark:bg-gray-700">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    <strong>Cliente:</strong> <?php echo e($revenueStats['ultimo_resumo']->customer->nomefantasia ?? 'N/A'); ?><br>
                    <strong>Período:</strong> <?php echo e($revenueStats['ultimo_resumo']->mes); ?>/<?php echo e($revenueStats['ultimo_resumo']->ano); ?><br>
                    <strong>Custo Total:</strong> R$ <?php echo e(number_format($revenueStats['ultimo_resumo']->custo_total ?? 0, 2, ',', '.')); ?><br>
                    <strong>Última Atualização:</strong> <?php echo e($revenueStats['ultimo_resumo']->updated_at?->format('d/m/Y H:i:s')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($batchStats['batches'])): ?>
            <div class="p-4 mb-4 border border-indigo-200 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 dark:border-indigo-700">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-xs">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $batchStats['batches']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-indigo-100 dark:border-indigo-800">
                                <td class="py-2 text-indigo-900 dark:text-indigo-100">#<?php echo e($batch['customer_id']); ?></td>
                                <td class="py-2 text-indigo-900 dark:text-indigo-100"><?php echo e($batch['mes']); ?>/<?php echo e($batch['ano']); ?></td>
                                <td class="py-2 text-right text-indigo-900 dark:text-indigo-100"><?php echo e($batch['cdrs_count']); ?></td>
                            </tr>
            ...
            <div class="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button wire:click="flushBatches" wire:loading.attr="disabled"
                    <?php if(($batchStats['total_batches'] ?? 0) > 0): ?> wire:confirm="Processar <?php echo e($batchStats['total_batches']); ?> batch(es) pendente(s)?" <?php endif; ?>
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition-all duration-200 rounded-lg shadow-sm
                    <?php echo e(($batchStats['total_batches'] ?? 0) > 0 ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-gray-400 cursor-not-allowed'); ?>"
                    <?php echo e(($batchStats['total_batches'] ?? 0) === 0 ? 'disabled' : ''); ?>>
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'play'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
...
<?php endif; ?>
                    <span wire:loading.remove wire:target="flushBatches">
                        Processar Batches <?php echo e(($batchStats['total_batches'] ?? 0) > 0 ? '(' . $batchStats['total_batches'] . ')' : ''); ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col items-start gap-2 p-4 border border-indigo-200 rounded-lg bg-indigo-50/50 dark:bg-indigo-900/10 dark:border-indigo-700">
                    ...
                    <button wire:click="atualizarReceitaProdutos" wire:loading.attr="disabled"
                        wire:confirm="Atualizar receita de produtos para <?php echo e(now()->month); ?>/<?php echo e(now()->year); ?>?"
                        ...
                        <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'shopping-cart'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col items-start gap-2 p-4 border border-red-200 rounded-lg bg-red-50/50 dark:bg-red-900/10 dark:border-red-700">
                    ...
                    <button wire:click="openReabrirFaturasModal" wire:loading.attr="disabled"
                        ...
                        <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'lock-open'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
        ...
        <div class="p-6 mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-3">
                <div class="p-4 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e(number_format($carrierStats['total_relatorios'] ?? 0, 0, ',', '.')); ?></p>
                </div>
                ...
                <div class="p-4 bg-gradient-to-br from-amber-500 to-amber-600 rounded-lg shadow">
                    ...
                    <p class="text-3xl font-bold text-white"><?php echo e(number_format($carrierStats['mes_atual'] ?? 0, 0, ',', '.')); ?></p>
                </div>
                ...
                <div class="p-4 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg shadow">
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e($carrierStats['ultimo_mes'] ?? 'N/A'); ?></p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carrierStats['ultimo_relatorio'] ?? null): ?>
                        <p class="text-xs text-yellow-100 mt-1"><?php echo e($carrierStats['ultimo_relatorio']->updated_at?->format('d/m/Y H:i')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div class="flex flex-col p-4 border border-gray-200 rounded-lg dark:border-gray-700">
                    <div class="mb-3">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            Processa relatórios de <?php echo e(now()->format('m/Y')); ?>

                        </p>
                    </div>
                    <button wire:click="gerarRelatoriosOperadora" wire:loading.attr="disabled"
                        wire:confirm="Gerar relatórios de operadora para <?php echo e(now()->format('m/Y')); ?>?"
                        ...
                        <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'document-text'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col p-4 border-2 border-orange-300 rounded-lg bg-orange-50 dark:bg-orange-900/10 dark:border-orange-700">
                    ...
                    <button wire:click="openGerarRelatorioOperadoraModal"
                        ...
                        <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'calendar'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col p-4 border border-gray-200 rounded-lg dark:border-gray-700">
                    <div class="mb-3">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            Processa relatórios de <?php echo e(now()->subMonth()->format('m/Y')); ?> (automático)
                        </p>
                    </div>
                    <button wire:click="processarRelatoriosMesAnterior" wire:loading.attr="disabled"
                        wire:confirm="Processar relatórios de <?php echo e(now()->subMonth()->format('m/Y')); ?>?"
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-center p-3 mt-4 border-t border-gray-200 dark:border-gray-700">
                <a href="/report/carrier" target="_blank"
                    ...
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'chart-bar'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'arrow-top-right-on-square'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component = TallStackUi\View\Components\Modal::resolve(['wire' => 'reprocessModal','size' => 'lg','persistent' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="p-3 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/20 dark:border-blue-800">
                <div class="flex items-start gap-2">
                    <?php if (isset($component)) { $__componentOriginalcf0c10903472319464d99a08725e554d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf0c10903472319464d99a08725e554d = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Icon::resolve(['name' => 'information-circle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\TallStackUi\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf0c10903472319464d99a08725e554d)): ?>
<?php $attributes = $__attributesOriginalcf0c10903472319464d99a08725e554d; ?>
...
<?php endif; ?>
            ...
            <div>
                ...
                <select wire:model.live="reprocessStatus"
                    ...
                    <option value="Erro_Tarifa">Erro Tarifa (<?php echo e($stats['erro_tarifa'] ?? 0); ?>)</option>
                    <option value="Tarifa_Nao_Encontrada">Tarifa Não Encontrada (<?php echo e($stats['tarifa_nao_encontrada'] ?? 0); ?>)</option>
                    <option value="Dados_Invalidos">Dados Inválidos (<?php echo e($stats['dados_invalidos'] ?? 0); ?>)</option>
                    <option value="Erro_Permanente">Erro Permanente (<?php echo e($stats['erro_permanente'] ?? 0); ?>)</option>
                    <option value="Tarifada" class="bg-orange-50 dark:bg-orange-900 font-semibold">⚠️ Tarifada - Retarifar (<?php echo e($stats['tarifada'] ?? 0); ?>)</option>
                </select>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reprocessStatus === 'Tarifada'): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select wire:model="reprocessCarrierId"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Models\Carrier::orderBy('operadora')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($carrier->id); ?>"><?php echo e($carrier->operadora); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select wire:model="reprocessCustomerId"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Models\Customer::orderBy('nomefantasia')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->nomefantasia ?? $customer->razaosocial); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </select>
                </div>
            </div>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal93360b397272e82c601608cfc5cba0d9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal93360b397272e82c601608cfc5cba0d9 = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Modal::resolve(['wire' => 'revenueReprocessModal','title' => 'Reprocessar Resumos Mensais de Receita','size' => '2xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <div class="space-y-4">
                ...
                <div>
                    ...
                    <select wire:model.live="revenueReprocessMes"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 12; $i++): ?>
                            <option value="<?php echo e($i); ?>"><?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?> - <?php echo e(\Carbon\Carbon::create()->month($i)->locale('pt_BR')->monthName); ?></option>
            ...
            <div class="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($revenueReprocessModeLote): ?>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Processará <?php echo e($revenueReprocessNumMeses); ?> mês(es) consecutivos a partir de <?php echo e(str_pad($revenueReprocessMes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($revenueReprocessAno); ?>
            ...
            <!-- Preview -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->revenueReprocessPreview && isset($this->revenueReprocessPreview['periodos'])): ?>
            <div class="p-4 border-l-4 border-purple-500 rounded bg-purple-50 dark:bg-purple-900/20">
                <h5 class="mb-2 text-sm font-semibold text-purple-800 dark:text-purple-300">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($revenueReprocessModeLote && isset($this->revenueReprocessPreview['periodos'])): ?>
                        - <?php echo e(count($this->revenueReprocessPreview['periodos'])); ?> Mês(es)
                    <?php else: ?>
                        - <?php echo e(str_pad($revenueReprocessMes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($revenueReprocessAno); ?>

                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </h5>
                <div class="text-sm">
                    <p class="text-purple-700 dark:text-purple-400">
                        <strong>Total de Faturas:</strong> <?php echo e(number_format($this->revenueReprocessPreview['totalFaturas'] ?? 0, 0, ',', '.')); ?>

                    </p>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($revenueReprocessCustomerId): ?>
                    <p class="mt-1 text-xs text-purple-600 dark:text-purple-400">
                        Filtrando apenas cliente ID: <?php echo e($revenueReprocessCustomerId); ?>
                ...
                <div class="mt-3 pt-3 border-t border-purple-200 dark:border-purple-700">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->revenueReprocessPreview['periodos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="px-2 py-1 text-xs font-medium rounded
                                <?php echo e($periodo['faturas'] > 0
                                ...
                                <?php echo e($periodo['label']); ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($periodo['faturas'] > 0): ?>
                                    (<?php echo e($periodo['faturas']); ?>)
                                <?php else: ?>
                                    (0)
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($this->revenueReprocessPreview['totalFaturas'] ?? 0) === 0): ?>
                <p class="mt-2 text-xs text-orange-600 dark:text-orange-400 font-semibold">
                    ...
                    <?php else: ?>
                        para <?php echo e(str_pad($revenueReprocessMes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($revenueReprocessAno); ?>.
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($revenueReprocessCustomerId): ?>
                        <br>Verifique se o cliente ID <?php echo e($revenueReprocessCustomerId); ?> possui faturas nesses períodos.
                    <?php else: ?>
            ...
            <div class="p-3 border-l-4 border-yellow-500 rounded bg-yellow-50 dark:bg-yellow-900/20">
                <p class="text-xs text-yellow-700 dark:text-yellow-400">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($revenueReprocessModeLote): ?>
                        <strong>em <?php echo e($revenueReprocessNumMeses); ?> mês(es)</strong>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>.
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal93360b397272e82c601608cfc5cba0d9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal93360b397272e82c601608cfc5cba0d9 = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Modal::resolve(['wire' => 'fecharFaturasModal','title' => 'Fechar Faturamento Mensal','size' => '2xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fecharFaturasModeLote): ?>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Número de Meses (a partir do mês/ano selecionado)
                    </label>
                    <input type="number" wire:model.live="fecharFaturasNumMeses" min="1" max="24"
                        ...
                        placeholder="12">
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Processará <?php echo e($fecharFaturasNumMeses); ?> mês(es) retroativamente a partir de <?php echo e(str_pad($fecharFaturasMes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($fecharFaturasAno); ?>
            ...
            <!-- Preview -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($fecharFaturasPreview)): ?>
            <div class="p-4 border-l-4 border-blue-500 rounded bg-blue-50 dark:bg-blue-900/20">
                <h5 class="mb-2 text-sm font-semibold text-blue-800 dark:text-blue-300">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fecharFaturasModeLote && isset($fecharFaturasPreview['periodos'])): ?>
                        - <?php echo e($fecharFaturasPreview['periodos']); ?> Mês(es)
                    <?php else: ?>
                        - <?php echo e(str_pad($fecharFaturasMes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($fecharFaturasAno); ?>
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        <p class="text-blue-700 dark:text-blue-400">
                            <strong>Faturas de Clientes:</strong> <?php echo e(number_format($fecharFaturasPreview['faturas_clientes'] ?? 0, 0, ',', '.')); ?>

                        </p>
                    </div>
                    <div>
                        <p class="text-blue-700 dark:text-blue-400">
                            <strong>Relatórios de Operadoras:</strong> <?php echo e(number_format($fecharFaturasPreview['relatorios_operadoras'] ?? 0, 0, ',', '.')); ?>

                        </p>
                    </div>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fecharFaturasModeLote && isset($fecharFaturasPreview['meses'])): ?>
                <div class="mt-3 pt-3 border-t border-blue-200 dark:border-blue-700">
                    <p class="mb-2 text-xs font-semibold text-blue-800 dark:text-blue-300">
                        Períodos que serão fechados:
                    </p>
                    <div class="flex flex-wrap gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fecharFaturasPreview['meses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($fecharFaturasPreview['faturas_clientes'] ?? 0) === 0 && ($fecharFaturasPreview['relatorios_operadoras'] ?? 0) === 0): ?>
                <p class="mt-2 text-xs text-orange-600 dark:text-orange-400 font-semibold">
                    ⚠️ Nenhuma fatura em aberto encontrada
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fecharFaturasModeLote): ?>
                        para os períodos selecionados.
                    <?php else: ?>
                        para <?php echo e(str_pad($fecharFaturasMes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($fecharFaturasAno); ?>.
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
         ...
         <?php $__env->slot('footer', null, []); ?> 
            <div class="flex justify-end gap-3">
                ...
                <button wire:click="fecharFaturas" wire:loading.attr="disabled" type="button"
                    <?php if(($fecharFaturasPreview['faturas_clientes'] ?? 0) > 0 || ($fecharFaturasPreview['relatorios_operadoras'] ?? 0) > 0): ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal93360b397272e82c601608cfc5cba0d9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal93360b397272e82c601608cfc5cba0d9 = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Modal::resolve(['wire' => 'reabrirFaturasModal','title' => 'Reabrir Faturamento Fechado','size' => '2xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reabrirFaturasModeLote): ?>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Número de Meses (a partir do mês/ano selecionado)
                    </label>
                    <input type="number" wire:model.live="reabrirFaturasNumMeses" min="1" max="24"
                        ...
                        placeholder="12">
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Processará <?php echo e($reabrirFaturasNumMeses); ?> mês(es) retroativamente a partir de <?php echo e(str_pad($reabrirFaturasMes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($reabrirFaturasAno); ?>
            ...
            <div class="p-4 border-2 border-red-500 rounded bg-red-50 dark:bg-red-900/30">
                ...
                <ul class="text-xs text-red-700 dark:text-red-400 list-disc list-inside space-y-1">
                    <li>Faturas fechadas serão reabertas e poderão ser alteradas
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reabrirFaturasModeLote): ?>
                            <strong>(<?php echo e($reabrirFaturasNumMeses); ?> mês(es))</strong>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </li>
                    <li>Você (<?php echo e(auth()->user()->name ?? 'Usuário'); ?>) será registrado como responsável</li>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal93360b397272e82c601608cfc5cba0d9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal93360b397272e82c601608cfc5cba0d9 = $attributes; } ?>
<?php $component = TallStackUi\View\Components\Modal::resolve(['wire' => 'gerarRelatorioOperadoraModal','title' => 'Gerar Relatórios de Operadora','size' => '2xl'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                    ...
                    <select wire:model="gerarRelatorioMes"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 12; $i++): ?>
                            <option value="<?php echo e($i); ?>">
                                <?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?> - <?php echo e(\Carbon\Carbon::create()->month($i)->locale('pt_BR')->monthName); ?>
...
<?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\resources\views/livewire/maintenance/index.blade.php ENDPATH**/ ?>