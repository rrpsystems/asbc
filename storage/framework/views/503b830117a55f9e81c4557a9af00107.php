...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['id','label','error','invalidate']));
...
foreach (array_filter((['id','label','error','invalidate']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = TallStackUi\View\Components\Form\Label::resolve(['id' => $id,'label' => $label,'error' => $error,'invalidate' => $invalidate] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\storage\framework\views/311a1dea852d48d78f71659f570e54a5.blade.php ENDPATH**/ ?>