...
<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($label instanceof \Illuminate\View\ComponentSlot): ?>
        <?php echo e($label); ?>

    <?php elseif($label && is_string($label)): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => $id,'label' => $label,'error' => $error,'invalidate' => $invalidate]); ?>
...
<?php endif; ?>
    ...
    <div <?php if($attributes->get('floatable', false)): ?> x-ref="anchor" <?php endif; ?> class="<?php echo e($personalize['wrapper']); ?>">
        <?php echo $slot; ?>
...
<?php /**PATH C:\Users\Rafael Benedicto\Documents\Herd\asbc\vendor\tallstackui\tallstackui\src/resources/views/components/wrapper/input.blade.php ENDPATH**/ ?>