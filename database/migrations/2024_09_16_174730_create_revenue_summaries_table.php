...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('revenue_summaries', function (Blueprint $table) {
            ...
            $table->integer('minutos_fixo')->default(0);
            $table->integer('minutos_movel')->default(0);
            $table->integer('minutos_internacional')->default(0);
            $table->decimal('valor_plano', 10, 2)->default(0.00);
            $table->decimal('excedente_fixo', 10, 2)->default(0.00);
            $table->decimal('excedente_movel', 10, 2)->default(0.00);
            $table->decimal('excedente_internal', 10, 2)->default(0.00);
            $table->decimal('excedente_total', 10, 2)->default(0.00);
            $table->integer('minutos_total')->default(0);
