            ...
            <div class="p-4 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-md">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-2xl font-bold text-white">
                            {{ number_format(ceil($totals->minutos_projetados / 60), 0, '.', '.') }} min
                        </p>
                    </div>
                    <div class="p-3 bg-white/20 rounded-full">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @forelse ($forecasts as $item)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">
                                {{ number_format(ceil($item->minutos_total / 60), 0, '.', '.') }} min /
                                <span class="font-medium text-purple-600 dark:text-purple-400">
                                    {{ number_format(ceil($item->minutos_projetados / 60), 0, '.', '.') }} min
                                </span>
                            </td>
