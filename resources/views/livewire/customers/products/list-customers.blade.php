                        ...
                        @forelse($customers as $customer)
                            <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-4 py-3">
                                    ...
                                    @if($customer->nomefantasia && $customer->razaosocial)
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="px-3 py-1 text-sm font-semibold rounded-full {{ $customer->produtos_ativos_count > 0 ? 'bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400' }}">
                                        {{ $customer->produtos_ativos_count }}
                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <a href="{{ route('customers.products', $customer->id) }}"
